...
var canFinish = function(numCourses, prerequisites) {
  ...
  prerequisites.forEach(([b, a]) => {
    ...
    inDegrees[a] = (inDegrees[a] || 0 )
    inDegrees[b] = (inDegrees[b] || 0 ) + 1
  })

  const queue = Object.keys(inDegrees).filter(v => !inDegrees[v])
  ...
  return Object.keys(inDegrees).filter(v => !!inDegrees[v]).length ? false : true

};

console.log(canFinish(2, [[0, 1]])) // true
console.log(canFinish(2, [[1,0],[0,1]])) // false
console.log(canFinish(4, [[3,1],[1,0],[2,0],[3,2]])) // true
